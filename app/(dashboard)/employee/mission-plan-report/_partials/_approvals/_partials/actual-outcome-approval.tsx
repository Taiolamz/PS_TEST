...
import ImpliedTaskApproval from "./implied-task-approval";
import { FieldArray, FormikProvider, useFormik } from "formik";
import { data } from "../_data/data";
import { Button } from "@/components/ui/button";
import { EditableLabel } from "@/components/fragment";

const ActualOutcomeApproval = () => {
  ...
  return (
    <div>
      <h1 className="font-normal text-[#5A5B5F] pb-[2rem] text-lg">
...
export default ActualOutcomeApproval;
