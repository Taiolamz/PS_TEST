    ...
    <>
      ...
      >
        ...
        <div className="flex justify-between items-center border-b border-[#E5E9EB] pb-2">
          <p className="text-[#1E1E1E] font-normal text-[17.52px]">
            Achieve Revenue from sales of Zojatech Products
          </p>
          <div className={`${rowCenterClass} !gap-5`}>
            <p className={topBtnBorderClass}>View Challenges</p>
            <div className={`${topBtnBorderClass} flex gap-2 items-center`}>
              <p>Comments</p>
              <p>{commentIcon}</p>
            </div>
            <div
        ...
        <div className="flex flex-col gap-3 mt-4">
          <div className="flex justify-between items-center border-b border-[#E5E9EB] pb-5 pt-4">
            ...
            <div className="flex gap-1 items-center">
              ...
              <p className="text-[#FFC043] font-medium text-[19.47px]">{67}%</p>
            </div>
          </div>
          ...
          >
            <div>
              <p className="text-[#3E4345] font-semibold text-base">
                {`Implied Task 1: ${"Sell and Market Revvex as a user product"} - ${50}%`}
              </p>
            </div>
                        ...
                        <>
                          ...
                          >
                            {sub_outcomes.map((chi, idx) => {
                              ...
                              return (
                                <tr key={idx} className="grid grid-cols-3">
