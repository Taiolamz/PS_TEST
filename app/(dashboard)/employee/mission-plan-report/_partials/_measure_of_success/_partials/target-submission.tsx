...
import { fakehistoryData } from "../_data/data";
    ...
    <div className="mt-2 space-y-7">
      <section className="border border-[var(--input-border)] bg-[var(--bg-white-200)] px-6 py-5">
        <header className="lg:flex items-center justify-between">
          ...
          <h3 className="text-lg font-semibold max-lg:mt-3 items-center gap-x-1 text-[var(--text-color4)]">
            Percent Completed:{" "}
            <span className=" text-lg font-semibold text-green-500">{74}%</span>
          </h3>
        </header>
        <main className="mt-7 lg:flex gap-x-3">
          <section className="w-full mb-6">
            <div className="grid grid-cols-9 gap-x-1">
              ...
              <p className=" col-span-2 text-[var(--text-color2)] text-sm">
                Weight
              </p>
              <p className=" col-span-1 text-[var(--text-color2)] text-sm">
                Unit
              </p>
              <p className=" col-span-2 text-[var(--text-color2)] text-sm">
                Yearly Target
              ...
              <p className=" col-span-2 text-[var(--text-color2)] text-xs">
                80%
              </p>
              <p className=" col-span-1 text-[var(--text-color2)] text-xs">%</p>
              <p className=" col-span-2 text-[var(--text-color2)] text-xs">
                200
              </p>
            </div>
      ...
      <section className="border border-[var(--input-border)] bg-[var(--bg-white-200)] px-6 py-5">
        <header className="lg:flex items-center justify-between">
          ...
          <h3 className="text-lg font-semibold max-lg:mt-3 items-center gap-x-1 text-[var(--text-color4)]">
            Percent Completed:{" "}
            <span className=" text-lg font-semibold text-red-500">{28}%</span>
          </h3>
        </header>
        <main className="mt-7 lg:flex gap-x-3">
          <section className="w-full mb-6">
            <div className="grid grid-cols-9 gap-x-1">
              ...
              <p className="border-l pl-1 col-span-2 text-[var(--text-color2)] text-xs">
                80%
              </p>
              <p className=" col-span-1 text-[var(--text-color2)] text-xs">%</p>
              <p className=" col-span-2 text-[var(--text-color2)] text-xs">
