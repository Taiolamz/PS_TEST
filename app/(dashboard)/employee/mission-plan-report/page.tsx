...
const MissionPlanReport = () => {
  ...
  const handleTitle = () => {
    switch (view) {
      case "specified_task_detail_view":
        return "Specified Task Overview";
    }
  };

  return (
    <DashboardLayout headerTitle={"Mission Plan Report"} back={!!view}>
      <div className="pb-10 overflow-x-hidden">
        ...
        {/* {ui === "my_report" && view ? (
          <div className="flex gap-3 items-center mt-5 pl-8">
            <div
            ...
            >
              ...
              <p className="text-sm text-[#6E7C87]">Back</p>
            </div>
            <p className="text-[#3E4345] font-medium text-lg">
              {handleTitle()}
            </p>
          </div>
        ) : null} */}
        ...
        <div className="pt-2 px-5">{getView()}</div>
      </div>
    </DashboardLayout>
  );
};
