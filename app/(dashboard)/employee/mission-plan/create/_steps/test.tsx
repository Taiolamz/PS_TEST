...
const ImpliedTask = () => {
  ...
  //   const updatedSubItems = [...(formik.values.tasks[index].subItems || []), newSubItem];

  //   formik.setFieldValue(`tasks.${index}.subItems`, updatedSubItems);
  // };
  const handleAddMoreImpliedTasks = (groupIndex: number) => {
    const newTask = {
      task: "",
      weight: "",
      percentage: "",
    ...
    updatedTasks[groupIndex] = [...updatedTasks[groupIndex], newTask];
    formik.setFieldValue("tasks", updatedTasks);
  };

  //   const handleAddMoreImpliedTasks = (index: number) => {
  //     // const currentSubItems = formik.values.tasks[index] || [];
  //     const currentSubItems = formik.values.tasks[index] || [];
  ...
  //     formik.setFieldValue(`tasks`, updatedSubItems);
  //   };
                              ...
                              content={
                                <>
                                  <div>
                                    ...
                                    {formik?.values?.tasks &&
                                      formik?.values?.tasks.length > 0 &&
                                      (formik?.values?.tasks as any[]).map(
                                        (subItem, subIndex) => {
                                              ...
                                              <div className="grid lg:grid-cols-3 gap-x-3 gap-y-4">
                                                <div>
                                                  <Input
                                                    ...
                                                    placeholder="Input implied task"
                                                    className="mr-2 w-full"
                                                    value={
                                                      formik.values.tasks[index]
                                                        .task
