                ...
                <Form>
                    ...
                    {({ insert, remove, push }) => (
                      <div className="flex flex-col gap-5">
                        {formik.values.strategic_pillars?.length > 0 &&
                          formik.values.strategic_pillars.map(
                              ...
                              <div key={idx}>
                                <div className="relative">
                                  <Input
                                    ...
                                    value={
                                      formik.values.strategic_pillars[idx]
                                        .pillar
                                    }
                                    onChange={(e) => {
                                      formik.setFieldValue(
                                        `strategic_pillars.${idx}.pillar`,
                                        e.target.value
                                      );
                                    }}
                                    error={
                                      formik?.errors?.strategic_pillars?.[idx]
                                        ?.pillar
                                    }
                                    touched={
                                      formik?.touched?.strategic_pillars?.[idx]
                                        ?.pillar
                                    }
                                  ...
                                  {formik.values.strategic_pillars.length >
                                    1 && (
                                    <button
                                      type="button"
                                      onClick={() => remove(idx)}
                  ...
                  <div className="mt-7 flex gap-4 items-center">
                    ...
                    <Button
                      ...
                      disabled={
                        isLoading ||
                        formik?.values?.strategic_pillars.some(
                          (d: Dictionary) => d.pillar === ""
                        )
                      }
                      loading={isLoading}
