...
const BulkUploadModal = ({
  ...
  const expectedFormat = {
    ...
    4: { name: "Gender", required: true, key: "gender" },
    ...
    12: { name: "Department", required: true, key: "department" },
    13: { name: "Unit", required: true, key: "unit" },
    14: { name: "Job Title", required: true, key: "job_title" },
    15: { name: "Phone Number", required: false, key: "phone_number" },
    16: { name: "Staff Number", required: true, key: "staff_number" },
