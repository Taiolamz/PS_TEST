...
export default function CustomDateInput({ label, id, name, className, labelClass, iconClass, onOpenPickNewDate = false, isRequired, handleChange, selected, error, touched, showIcon = true }: CustomDateInputProps) {
    return (
        <div className="relative">
            ...
            />
           {showIcon && <Calendar size={16} className={cn(
